...
namespace CheckoutSystemEngine
{
    public class Product
    {
        ...
        public static ExecutionResult<Product> Create(Guid id, string name, decimal unitPrice)
        {
            if (id == Guid.Empty)
            ...
            return ExecutionResult<Product>.CreateSuccess(new Product(id, name, unitPrice));
        }
    }
}
